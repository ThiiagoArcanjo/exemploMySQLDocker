...
* 1 - Crie uma rede da sua preferencia como o comando docker network create  usei o exemplo thiago_network(<b>docker network create</b> thiago_network).
...
* 4 - Copie e coloque o arquivo dbcopy.env na mesma pasta e renomeio para db.env
